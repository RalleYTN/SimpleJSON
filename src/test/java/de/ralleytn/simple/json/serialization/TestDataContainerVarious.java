...
public class TestDataContainerVarious {
	...
	@JSONAttribute(name = "map")			public LinkedHashMap<Object, Object> map = createObject();
	...
	@JSONAttribute(name = "map2")			public LinkedHashMap<Object, Object> map2 = createObjectWithAllPossibleTypes(this.date);
	
	@Override
	public boolean equals(Object obj) {
		
		if(obj != null && obj instanceof TestDataContainerVarious) {
			
			TestDataContainerVarious other = (TestDataContainerVarious)obj;

			return this.equals(this.string, other.string) &&
				   this.equals(this.stringNull, other.stringNull) &&
				   this.bTrue == other.bTrue &&
				   this.bFalse == other.bFalse &&
				   this.equals(this.bTrueInstance, other.bTrueInstance) &&
				   this.equals(this.bFalseInstance, other.bFalseInstance) &&
				   this.equals(this.bNullInstance, other.bNullInstance) &&
				   this.equals(this.person, other.person) &&
				   this.vByte == other.vByte &&
				   this.vShort == other.vShort &&
				   this.vInt == other.vInt &&
				   this.vLong == other.vLong &&
				   this.vFloat == other.vFloat &&
				   this.vDouble == other.vDouble &&
				   this.equals(new JSONObject(this.map).toString(), new JSONObject(other.map).toString()) &&
				   this.equals(this.collection, other.collection) &&
				   this.equals(this.iByte, other.iByte) &&
				   this.equals(this.iShort, other.iShort) &&
				   this.equals(this.iInt, other.iInt) &&
				   this.equals(this.iLong, other.iLong) &&
				   this.equals(this.iFloat, other.iFloat) &&
				   this.equals(this.iDouble, other.iDouble) &&
				   this.equals(this.iByteNull, other.iByteNull) &&
				   this.equals(this.iShortNull, other.iShortNull) &&
				   this.equals(this.iIntNull, other.iIntNull) &&
				   this.equals(this.iLongNull, other.iLongNull) &&
				   this.equals(this.iFloatNull, other.iFloatNull) &&
				   this.equals(this.iDoubleNull, other.iDoubleNull) &&
				   this.equals(this.vEnum, other.vEnum) &&
				   this.equals(this.vEnumNull, other.vEnumNull) &&
				   this.equals(new JSONObject(this.map2).toString(), new JSONObject(other.map2).toString());
		}
